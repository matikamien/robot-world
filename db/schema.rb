...
ActiveRecord::Schema.define(version: 2021_03_08_173233) do
  ...
  create_table "defects", force: :cascade do |t|
    ...
    t.bigint "part_id"
    t.string "type"
    t.index ["part_id"], name: "index_defects_on_part_id"
  end
  ...
  create_table "parts", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "car_id"
    t.index ["car_id"], name: "index_car_id"
  end
